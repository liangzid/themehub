(ns themes
  (:require [com.biffweb :as biff]
            [themes.email :as email]
            [themes.app :as app]
            [themes.home :as home]
            [themes.middleware :as mid]
            [themes.ui :as ui]
            [themes.worker :as worker]
            [themes.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (biff/catchall (require 'themes-test))
  (test/run-all-tests #"themes.*-test"))
